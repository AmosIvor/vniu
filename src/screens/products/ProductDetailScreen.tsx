        ...
        <View style={{ padding: 16, gap: 16, flex: 1 }}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
            ...
            >
              ...
              >
                <MaterialCommunityIcons name='minus-thick' size={20} color={colors.text} />
              </TouchableOpacity>
              <Text
                style={{
                  fontSize: 16,
              ...
              >
                <MaterialCommunityIcons name='plus-thick' size={20} color={colors.text} />
              </TouchableOpacity>
            </View>
          </View>
          ...
          <View>
            ...
            <Text style={{ color: colors.text, opacity: 0.75 }} numberOfLines={3}>
              Aute magna dolore sint ipsum dolor fugiat. Ad magna ad elit labore culpa sunt sint laboris consectetur
              sunt. Lorem excepteur occaecat reprehenderit nostrud culpa ad ex exercitation tempor.
            </Text>
          </View>
